...
# MUGSHOTS ==============================================================    
    ...
    async def mugshots(self, ctx, source: str = None, lastname: str = None):
        ...
        if ctx.invoked_subcommand is None:
            return await ctx.invoke(self.get_mugshot, source=source, lastname=lastname)
    ...
    async def get_mugshot(self, ctx, source: str = None, lastname: str = None):
        ...
        async with ctx.typing():
            if not lastname:
                ...
                getms = requests.get(f"http://www.jailbase.com/api/1/search/?source_id={source}&last_name={lastname}")
